...
def write_catalog(params,catalog = 'GLADE', savedir=''):
    fits = params['skymap_fits']
    event = params['superevent_id']
    probability = params['skymap_array']
    print("write_catalog function, probability = "+str(probability))
    
    if catalog == 'GLADE':
        print("Working with Glade catalog, savedir: "+str(savedir))
        ...
        print("index has length: "+str(len(index)))
